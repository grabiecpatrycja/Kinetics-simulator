from gui.events import temp_simulate_click
import tkinter as tk

def build_temperature_tab(parent):
    labels = {
        'Reaction order': '',
    ...
    button = tk.Button(parent, text='Simulate', command=lambda: temp_simulate_click(input_fields))
